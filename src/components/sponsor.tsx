...
export default function Sponsor() {
    return (
        <div className="flex flex-col items-start w-[390px] xl:w-[1040px] gap-[22px] xl:gap-[40px] text-[#222]">
            ...
            <span className='text-xs xl:text-xl font-semibold'>白金級</span>
            ...
            <span className="text-xs xl:text-xl font-semibold">金級</span>
            <div className="grid grid-cols-6 gap-3 mb-5">
                {/* <Image
                    src={'/images/album-cover.png'}
                    width={300}
            ...
            <span className="text-xs xl:text-xl font-semibold">銀級</span>
