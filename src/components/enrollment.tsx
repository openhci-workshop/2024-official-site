          ...
          >
            <div className="flex flex-col w-[324px] xl:w-[864px] h-[362px] xl:h-[607px] relative text-[#222] text-xl gap-3 xl:gap-5">
              <div className='flex flex-col gap-3'>
                ...
                <span className='text-xs xl:text-xl underline'>全國各大專院校升大三以上在學生，含學碩博應屆畢業生及碩博新生。</span>
              </div>
              <div className='flex flex-col gap-3'>
                <span className='text-sm xl:text-2xl font-medium'>報名方式</span>
                <span className='text-xs xl:text-xl'>一律填寫線上表單報名。本活動以報名資料填寫內容作為錄取參考依據， 報名先後順序不列入計分標準。</span>
              </div>
        ...
        <ol className="w-screen border-white flex justify-center border-t-2">
          ...
          <li className='ml-[76px] xl:ml-[245px] top-[-115px] xl:top-[-200px] relative'>
            <div className="w-[76px] xl:w-[245px] flex-start items-center block pt-0">
              <div className='text-center h-[37px] xl:h-[80px] w-[178px] mb-4 me-0 -ms-[80px]'>
                <p className="text-xs xl:text-base text-[#222]">
                  2022 年 7 月 18 日（一）
                </p>
                <p className="text-xs xl:text-xl text-[#222]">
                  報名開始
                </p>
              </div>    
              <div
              ...
              <div
                className="h-[57px] xl:h-[100px] w-[2px] rounded-full bg-white me-0 ms-1">
              </div>
              <div
                className="h-[9px] w-[9px] rounded-full bg-white -mt-[5px] me-0 ms-0">
              </div>                                
          ...
          <li>
            <div className="w-[76px] xl:w-[245px] flex-start items-center block pt-0">
              ...
              <div
                className="h-[57px] xl:h-[100px] w-[2px] rounded-full bg-white -mt-[5px] me-0 ms-1">
              </div>
              <div
                className="h-[9px] w-[9px] rounded-full bg-white -mt-[5px] me-0 ms-0">
              </div>
