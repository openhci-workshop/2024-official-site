  ...
  return (
    <div className="flex flex-col items-start w-[390px] xl:w-[1040px] gap-[55px] xl:gap-[100px] text-[#222]">
      <div className="relative flex flex-col gap-[22px] xl:gap-[40px]">
        ...
        <div
          className={clsx(
            'h-[263px] xl:h-[384px] w-[390px] xl:w-[1040px] rounded-[50%] z-10 flex justify-center items-center',
          )}
        ...
        >
          <div className=" w-[284px] xl:w-[864px] h-[130px] xl:h-[160px] relative text-xs xl:text-xl text-center">
      ...
      <div className="relative flex flex-col gap-[22px] xl:gap-[40px]">
        ...
        <div
          className={clsx(
            'h-[355px] xl:h-[515px] w-[390px] xl:w-[1040px] rounded-[50%] z-10 flex justify-center items-center',
          )}
        ...
        >
          <div className="flex flex-col w-[324px] xl:w-[862px] h-[292px] xl:h-[425px] relative text-xs xl:text-xl gap-3 xl:gap-5">
            <div className='flex flex-col gap-3'>
              <span className='text-sm xl:text-2xl font-medium'>活動時間</span>
              <div className='flex flex-col gap-1 underline tracking-wider'>
                <span>前置工作坊：6/22（六）- 6/23（日）</span>
                <span>正式工作坊：7/4（四）- 7/7（日）</span>
              </div>
            </div>
            <div className='flex flex-col gap-3'>
              <span className='text-sm xl:text-2xl font-medium'>活動地點</span>
              <span className='tracking-wider'>國立台灣大學 學新館（台北市大安區舟山路10巷1弄4號）</span>
            </div>
            <div className='flex flex-col gap-3'>
              <span className='text-sm xl:text-2xl font-medium'>活動費用</span>
              <span className='tracking-normal'>為推廣 HCI 學門，本活動免報名費，僅收取保證金、保險費用及其他費用。 獲得錄取資格之學員，請於指定時間內繳交各項費用，方能取得正式資格。為維持完整學習體驗，工作坊實行每日簽到，學員需全程參與以獲得保證金全額退還。</span>
            </div>
          </div>
        </div>
      </div>
