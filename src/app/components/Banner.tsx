    ...
    const TabletLayout = () => {
        return (
            <div className="absolute z-20 hidden w-full h-screen grid-cols-12 text-right md:grid xl:hidden grid-rows-12">
                ...
                <div
                    style={{ filter: 'blur(0.8px)' }}
                    className="col-span-12 col-start-2 pt-6 text-5xl leading-4 tracking-widest text-left text-white row-start-10 font-kompot drop-shadow-3xl "
                >
                    6
                </div>
                <div
                    style={{ filter: 'blur(0.8px)' }}
                    className="col-span-12 col-start-2 pt-12 pl-10 text-5xl leading-4 tracking-widest text-left text-white row-start-10 font-kompot drop-shadow-3xl "
                >
                    23
                </div>
                <div
