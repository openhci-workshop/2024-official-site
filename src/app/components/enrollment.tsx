            ...
            <div className="flex flex-col items-center w-full pt-12">
                <div className="flex flex-col items-center w-full gap-[55px] xl:gap-[120px]">
                    <div className="w-full relative flex flex-col mb-[22px] xl:mb-4 ">
                        <span className="items-start font-semibold text-md xl:text-3xl ">報名資訊</span>
                        <div
                ...
                <div className="relative left-0 top-[-55px] xl:top-[-40px] z-20">
                    <ol className="flex justify-center w-screen border-t-2 border-white">
                        {/* 1  */}
                        <li className="ml-[76px] md:ml-[130px] xl:ml-[220px] top-[-105px] xl:top-[-180px] relative">
                            <div className="w-[76px] md:w-[130px] xl:w-[220px] flex-start items-center block pt-0">
                                <div className="text-center h-[37px] xl:h-[80px] w-[178px] mb-4 me-0 -ms-[80px]">
                                    <p className="text-xs xl:text-base ">2022 年 7 月 18 日（一）</p>
                                    <p className="text-xs xl:text-xl ">報名開始</p>
                                </div>
                        ...
                        <li>
                            <div className="w-[76px] md:w-[130px] xl:w-[220px] flex-start items-center block pt-0">
                                ...
                                <div className="text-center h-[37px] xl:h-[80px] w-[178px] mt-4 me-0 -ms-[80px]">
                                    <p className="text-xs xl:text-base ">2022 年 7 月 18 日（一）</p>
                                    <p className="text-xs xl:text-xl ">報名結束</p>
                                </div>
                            </div>
                        </li>

                        {/* 3  */}
                        <li className="top-[-105px] xl:top-[-180px] relative">
                            <div className="w-[76px] md:w-[130px] xl:w-[220px] flex-start items-center block pt-0">
                                <div className="text-center h-[37px] xl:h-[80px] w-[178px] mb-4 me-0 -ms-[80px]">
                                    <p className="text-xs xl:text-base ">2022 年 7 月 18 日（一）</p>
                                    <p className="text-xs xl:text-xl ">正取名單公布</p>
                                </div>
                                <div className="h-[9px] w-[9px] rounded-full bg-white -mt-[5px] me-0 ms-0"></div>
                                <div className="h-[48px] xl:h-[80px] w-[2px] rounded-full bg-white -mt-[5px] me-0 ms-1"></div>
                        ...
                        <li>
                            <div className="w-[76px] md:w-[130px] xl:w-[220px] flex-start items-center block pt-0">
                                ...
                                <div className="text-center h-[37px] xl:h-[80px] w-[178px] mt-4 me-0 -ms-[80px]">
                                    <p className="text-xs xl:text-base ">2022 年 7 月 18 日（一）</p>
                                    <p className="text-xs xl:text-xl ">遞補備取通知</p>
                                </div>
                            </div>
                        </li>
                    </ol>
