...
export default function Footer() {
    return (
        <div className="w-full ">
            <h1 className="mb-5 font-semibold text-md xl:text-3xl md:text-2xl">活動地點</h1>
            <div className="flex flex-row gap-4 h-[243px]">
                ...
                <div className="flex flex-col items-center justify-between w-1/2 ">
                    ...
                    <div>
                        <p className="font-bold text-center text-xxs xl:text-md md:text-sm">
                            © COPYRIGHT 2024 OpenHCI&apos;24
                        </p>
